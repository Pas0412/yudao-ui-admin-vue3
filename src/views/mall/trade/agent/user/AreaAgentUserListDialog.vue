<template>
  <Dialog v-model="dialogVisible" title="代理人列表" width="75%">
    <ContentWrap>
      <!-- 搜索工作栏 -->
      <el-form
        class="-mb-15px"
      ...
      >
        <el-form-item label="用户类型" prop="level">
          <el-radio-group v-model="queryParams.level" @change="handleQuery">
            ...
            <el-radio-button value="1">一级代理</el-radio-button>
    ...
    <ContentWrap>
      <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
        ...
        <el-table-column label="代理地区" align="center" prop="region" min-width="100px" />
        <el-table-column
          label="代理人数"
          align="center"
          prop="areaAgentUserCount"
          min-width="80px"
        />
        <el-table-column
          label="代理订单数量"
          ...
          min-width="110px"
        />
        <el-table-column label="代理资格" align="center" prop="areaAgentEnabled" min-width="80px">
          <template #default="scope">
            <el-tag v-if="scope.row.areaAgentEnabled">有</el-tag>
...
/** 代理人列表 */
defineOptions({ name: 'AreaAgentUserListDialog' })
